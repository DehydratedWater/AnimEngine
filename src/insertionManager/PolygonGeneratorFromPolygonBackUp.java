...
import polygonEngine.RaundingPolygonTool;
...
public class PolygonGeneratorFromPolygonBackUp 
{
	private int lastPoint;
	private int PointCounter;
	
	public FilledPolygonWithCurves generateFilledPolygon(Frame f, PolygonInfoBackup pb)
	{
		ArrayList<Integer> indexTab = pb.listOfConns;
		ArrayList<Point> points = f.gco().getPointTab();
		ArrayList<Connection> conections = f.gco().getConnectionTab();
